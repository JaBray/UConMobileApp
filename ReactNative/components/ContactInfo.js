  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text}>We have a new P.O. Box! Please label as ATN: Vendors Coordinator, ATN: Events Coordinator, or ATN: Volunteer Coordinator as appropriate.</Text>
